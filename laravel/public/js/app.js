...
var app = new Vue({
  ...
  computed: {
    resultMenuItemList: function resultMenuItemList() {
      ...
      if (this.searchMenuItem) {
        return this.menuItemList.filter(function (i) {
          return _this2.searchMenuItem.toLowerCase().split(' ').every(function (v) {
    ...
    resultMenuGridList: function resultMenuGridList() {
      ...
      if (this.searchMenuItem) {
        list = list.filter(function (i) {
          return _this3.searchMenuItem.toLowerCase().split(' ').every(function (v) {
            return i.name.toLowerCase().includes(v);
          });
        });
      }
      ...
      if (this.selectedCategory) {
        list = list.filter(function (i) {
          return _this3.selectedCategory.toLowerCase().split(' ').every(function (v) {
    ...
    resultCustomerList: function resultCustomerList() {
      ...
      if (this.searchCustomerItem) {
        return this.customerList.filter(function (i) {
          return _this4.searchCustomerItem.toLowerCase().split(' ').every(function (v) {
            return i.name.toLowerCase().includes(v);
          });
        });
      }
    ...
    resultOrderList: function resultOrderList() {
      ...
      if (this.searchOrderItem) {
        return this.orderHistoryList.filter(function (i) {
          return _this5.searchOrderItem.toLowerCase().split(' ').every(function (v) {
  ...
  methods: {
    ...
    removeMenuItem: function removeMenuItem(item) {
      ...
      if (confirm("Are you sure you want to remove ".concat(item.name, "?"))) {
        _this.showLoader();
    ...
    saveMenuItem: function saveMenuItem() {
      ...
      if (confirm('Are you sure you want to save this menu item?')) {
        ...
        axios.post(api, this.selectedMenuItem).then(function (response) {
          ...
          alert('Menu item has been saved successfully.'); // Close modal
        })["catch"](function (error) {
          console.log(error);
        });
      }
    ...
    addToCart: function addToCart(item) {
      var ind = _.findIndex(this.cartList, function (c) {
        return c.id == item.id;
      });
    ...
    updateQuantity: function updateQuantity(item, index) {
      var isAdd = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
      var qty = isAdd ? item.quantity + 1 : item.quantity - 1;
    ...
    updateCartBill: function updateCartBill() {
      var subtotal = 0;
      this.cartList.forEach(function (c) {
    ...
    updateOrderBill: function updateOrderBill() {
      var subtotal = 0;
      this.orderList.forEach(function (c) {
        subtotal += c.quantity * c.price;
      });
    ...
    getOrderItemList: function getOrderItemList() {
      ...
      axios.get(api).then(function (response) {
        ...
        list.forEach(function (e) {
          var ind = _.findIndex(_this.menuItemList, function (c) {
            return c.id == e.menu_id;
          });
    ...
    placeOrder: function placeOrder() {
      ...
      if (confirm('Are you sure you want to place your order?')) {
        ...
        axios.post(api, params).then(function (response) {
          ...
          _this.cartList.forEach(function (e) {
            var ind = _.findIndex(_this.menuItemList, function (c) {
              return c.id == e.menu_id;
            });
    ...
    showCustomerDetails: function showCustomerDetails(item) {
      var ind = _.findIndex(this.customerList, function (c) {
        return item.customer_id == c.id;
      });

      if (ind >= 0) {
        var _cus$contact, _cus$address, _cus$email, _item$customer_remark;

        var cus = this.customerList[ind];
        this.viewCustomer = {
          name: cus.name,
          contact: (_cus$contact = cus.contact) !== null && _cus$contact !== void 0 ? _cus$contact : '---',
          address: (_cus$address = cus.address) !== null && _cus$address !== void 0 ? _cus$address : '---',
          email: (_cus$email = cus.email) !== null && _cus$email !== void 0 ? _cus$email : '---',
          remarks: (_item$customer_remark = item.customer_remarks) !== null && _item$customer_remark !== void 0 ? _item$customer_remark : '---',
    ...
    getSelectedCategory: function getSelectedCategory() {
      ...
      setInterval(function () {
        ...
        var value = (_$$val = $('#category').val()) !== null && _$$val !== void 0 ? _$$val : 'Appetizer';
